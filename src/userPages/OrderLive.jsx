...
export default function OrderLive() {
  ...
  useEffect(() => {
    const q = query(collection(db, "liveOrder"), where("isActive", "==", true));
    ...
    return (
      <>
        ...
        <div className="w-full h-screen flex flex-col items-center justify-center ">
          ...
          <p className="text-[#5b3a28] text-xl font-semibold">
            No slot started
          </p>
        </div>
      </>
    ...
    <>
      ...
      <div className="min-h-screen p-5">
          ...
          {myOrder &&
            myOrder.map((o) => {
              o.tokenNumber == live.tokenNumber && (
                <div>Yay your order is here</div>
              );
            })}
          <div className="bg-white border border-[#d9cbb8] p-6 rounded-3xl shadow">
            <h2 className="text-sm text-[#5b3a28] opacity-70 text-center">
              Current Token
            </h2>
        ...
        <div className="bg-white border border-[#d9cbb8] p-5 rounded-3xl shadow">
          <h2 className="text-xl font-semibold text-[#452e1c] mb-3">
            All Orders
          </h2>
